                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-gray-50 border-b border-surface-border">
                                    ...
                                    <th className="px-4 py-3 text-left text-[10px] font-mono font-medium text-gray-500 uppercase">Referensi</th>
                                ...
                                {filtered.length === 0 ? (
                                    ...
                                    filtered.map(t => (
                                        <tr key={t.id} className="hover:bg-gray-50/50">
                                            ...
                                            <td className="px-4 py-3 text-sm font-mono text-gray-700">{t.referensi}</td>
                                            ...
                                            <td className="px-4 py-3 text-sm font-mono text-right font-bold text-primary-900">{fmt(t.nominal)}</td>
                                            <td className="px-4 py-3 text-sm font-hanken">
