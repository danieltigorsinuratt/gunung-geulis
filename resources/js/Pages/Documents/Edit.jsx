...
export default function DocumentEdit({ document = {}, usersByDivisi = {} }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        batas_waktu: document.batas_waktu || '',
        masa_berlaku: document.masa_berlaku || false,
        file: null,
    });
            ...
            <div className="max-w-[1024px] mx-auto">
                ...
                <div className="mb-6 md:mb-8">
                    ...
                    <p className="text-sm font-hanken text-gray-600 mt-1">
                        Ubah informasi dokumen <span className="font-bold text-primary-900">#{document.nomor_surat}</span>
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 md:gap-8">
                            ...
                            >
                                ...
                                {file ? (
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm font-hanken font-bold text-gray-900">{document.file_original_name}</p>
                                        <p className="text-xs font-hanken text-gray-500 mt-1">
                                            File saat ini · Klik untuk ganti
                                        </p>
                                    </div>
                                ) : (
                                    <>
                    ...
                    {/* Bottom Section: Penerima + Tanggal */}
                    <div className="bg-white shadow-sm rounded-xl border border-surface-border p-4 md:p-6">
