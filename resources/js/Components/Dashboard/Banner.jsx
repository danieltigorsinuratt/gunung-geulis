export default function Banner() {
    return (
        <div className="relative h-[180px] md:h-[240px] rounded-2xl overflow-hidden shadow-lg">
            {/* Background image */}
            <img
            ...
            {/* Content */}
            <div className="relative h-full flex items-center px-4 md:px-10 max-w-[448px]">
                <div className="flex flex-col gap-2 md:gap-2.5">
                    ...
                    <h3 className="text-lg md:text-2xl font-hanken font-semibold text-white leading-6 md:leading-7">
                        Hewan Qurban Berkualitas - Aman, Sehat, Utuh, dan Halal (ASUH).
                    </h3>
                    <p className="text-xs md:text-sm font-hanken text-white/90 leading-4 md:leading-5">
