...
const getNavigationByRole = (roleType, unreadCount, approvalCount) => {
    if (roleType === 'superadmin') {
        return [
            ...
            { type: 'header', name: 'KEUANGAN' },
            { type: 'item', name: 'Dashboard Pembukuan', href: '/cash', icon: 'chart' },
            { type: 'divider' },
    ...
    if (roleType === 'manajer' || roleType === 'manager') {
        return [
            ...
            { type: 'header', name: 'KEUANGAN' },
            { type: 'item', name: 'Dashboard Pembukuan', href: '/cash', icon: 'chart' },
            { type: 'item', name: 'Approval Transaksi', href: '/cash/approval', icon: 'check-circle' },
